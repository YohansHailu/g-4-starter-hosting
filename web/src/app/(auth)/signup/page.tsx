        ...
        <div className="mx-auto">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
              <button
                type="submit"
                className="flex justify-center rounded-sm bg-blue-600 mt-3 px-4 py-2.5 text-sm font-light leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                SIGN UP
              </button>
            </div>
